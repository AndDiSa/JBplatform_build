...
KERNEL_OUT := /vmware-images/android-aosp/out/target/product/i9100/obj/KERNEL_OBJ
KERNEL_CONFIG := $(KERNEL_OUT)/.config

TARGET_KERNEL_CUSTOM_TOOLCHAIN := /vmware-images/android-toolchain-eabi
...
ARM_EABI_TOOLCHAIN := $(TARGET_KERNEL_CUSTOM_TOOLCHAIN)/bin
endif
...
ifeq ($(TARGET_ARCH),arm)
        ARM_CROSS_COMPILE := "$(ccache) CROSS_COMPILE=$(TARGET_KERNEL_CUSTOM_TOOLCHAIN)/bin/arm-linux-androideabi-"
endif
